<?php
  class CarParkInfoDAO{
    ...
    // 1. declare TWO private properties -- $id, $carParkInfo
    private $id;
    private $carParkInfo;
    
    // 2. add code for constructor
    public function __construct($carpark_id) {
      $this->id = $carpark_id;
      $this->initializeInfo();
    }
    
    // 3. add Getter method that returns $carpark_info array
    ...
    private function initializeInfo() {
      ...
      // create a URL to connects to data.gov.sg's API endpoint
      ...
      /* 4. Complete the following code 
          so that it accesses the total_lots, lots_available, and lot_type information    
          then populates $carpark_info array
          with Three key=>value pairs --
          "total_lots" => "<value>"
          "lots_available" => "<value>"
          "lot_type" => "<value>"

          Refer to CarParkList.php to understand
      ...
      */
      ...
      foreach ($carpark_data_array as $carpark_data_obj) {
        $carpark_info_obj = $carpark_data_obj->carpark_info[0];
        $this->carParkInfo['total_lots'] = $carpark_info_obj->total_lots;
        $this->carParkInfo['lot_type'] = $carpark_info_obj->lot_type;
        $this->carParkInfo['lots_available'] = $carpark_info_obj->lots_available;
      }
    ...
    /* Sample JSON data from data.gov.sg
       {} denotes JSON object, [] denotes JSON array
    {
  "items": [
    {
